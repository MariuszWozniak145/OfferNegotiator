...
public class ProductsController : ControllerBase
{
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows you to retrieve product with its offers by providing the unique identifier ("productId")
    ///     of the product as a part of the URL route.
    ///     After a successful retrieval, a response with an HTTP 200 (OK) status code will be
    ///     returned, and it will contain the product with its offers.
    /// </remarks>
    /// <response code="200">The product with the specified "productId" and its offers was successfully retrieved.</response>
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows you to delete an existing product by providing the unique identifier ("productId") of the product
