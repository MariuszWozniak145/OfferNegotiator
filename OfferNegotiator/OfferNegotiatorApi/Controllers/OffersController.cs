...
using OfferNegotiatorLogic.CQRS.Offers.Commands.Patch;
...
public class OffersController : ControllerBase
{
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to retrieve offer with releted product by providing the unique identifier ("offerId")
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to retrieve offers for specified client and product by providing the unique 
    ...
    /// </remarks>
    /// <response code="200">The offers for specified client and product were successfully retrieved.</response>
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to retrieve offers for specified client by providing the unique 
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to delete an existing offer by providing the unique identifier ("offerId") of the offer
    ...
    /// <response code="403">User does not have enough permissions (only the employee can delete the offer).</response>
    /// <response code="404">The offer with the specified "offerId" was not found.</response>
    ...
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to create a new offer by providing the necessary offer data in the request body using
    ...
    /// <response code="401">User was unauthorized or JWT was invalid.</response>
    /// <response code="403">User does not have enough permissions (only the client can create the offer).</response>
    ...
    #region Endpoint Description
    /// <summary>
    ///     Accepts an existing offer by its unique identifier (offerId).
    /// </summary>
    /// <param name="offerId">The unique identifier of the offer to be accepted.</param>
    /// <returns>
    ///     Returns an HTTP 200 (Ok) response upon successful acceptance of the offer.
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to accept an existing offer by providing the unique identifier ("offerId") of the offer
    ///     as part of the URL route. To use this endpoint, ensure that you are authenticated with a valid authorization token
    ...
    /// </remarks>
    /// <response code="200">The offer with the specified "offerId" was successfully accepted.</response>
    /// <response code="400">The offer with the specified "offerId" can not be accepted because product is not available.</response>
    /// <response code="401">User was unauthorized or JWT was invalid.</response>
    /// <response code="403">User does not have enough permissions (only the employee can accept the offer).</response>
    /// <response code="404">The offer with the specified "offerId" was not found.</response>
    ...
    {
        var result = await _mediator.Send(new AcceptOfferCommand(offerId));
        return Ok(result);
    }

    #region Endpoint Description
    /// <summary>
    ///     Reject an existing offer by its unique identifier (offerId).
    /// </summary>
    /// <param name="offerId">The unique identifier of the offer to be rejected.</param>
    /// <returns>
    ///     Returns an HTTP 200 (Ok) response upon successful rejection of the offer.
    /// </returns>
    /// <remarks>
    ///     This endpoint allows to reject an existing offer by providing the unique identifier ("offerId") of the offer
    ///     as part of the URL route. To use this endpoint ensure that you are authenticated with a valid authorization token
    ...
    /// </remarks>
    /// <response code="200">The offer with the specified "offerId" was successfully rejected.</response>
    /// <response code="400">The offer with the specified "offerId" cannot be rejected because it has an accepted status.</response>
    /// <response code="401">User was unauthorized or JWT was invalid.</response>
    /// <response code="403">User does not have enough permissions (only the employee can reject the offer).</response>
    /// <response code="404">The offer with the specified "offerId" was not found.</response>
    [ProducesResponseType(typeof(OfferReadDTO), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ExceptionOccuredReadDTO), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    ...
    {
        var result = await _mediator.Send(new RejectOfferCommand(offerId));
        return Ok(result);
    }
}
